# Describe the tools advertised to the model and their JSON arguments.
# The extension still validates every requested call before any local action.

from ..providers.chat_provider import ChatToolDefinition
