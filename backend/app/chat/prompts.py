# Build mode-specific model instructions and bounded request context.
# Source code and tool output are data to inspect, not instructions to trust.

import json
from typing import Protocol, Sequence

from ..api.api_models import AssistantMode, ScopeType
from ..providers.chat_provider import ChatMessage, ChatToolCall
...
def build_chat_messages(
    *,
    ...
    # Summary text is user-context data, not a new system instruction with higher authority.
    ...
    # Replay each call with its matching tool result so the provider sees valid conversation pairs.
