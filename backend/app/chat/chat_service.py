# Build model messages and normalize completed provider responses.
# The route owns HTTP streaming; the provider owns the external model connection.
...
from ..providers.chat_provider import ChatCompletion, ChatCompletionRequest, ChatToolDefinition
...
class ChatService:
    ...
    def build_completion_request(
        ...
        # Intersect requested tools with the mode's allowlist; a final-answer pass exposes no tools.
        enabled_tools = tuple(
