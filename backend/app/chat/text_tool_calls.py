# Support the bounded textual tool-call format emitted by some providers.
# Only a complete, standalone tool block is accepted as a tool request.
...
from ..providers.chat_provider import ChatToolCall
