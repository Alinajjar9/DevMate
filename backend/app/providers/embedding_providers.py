# Define the embedding provider contract and the batch shape for normalized vectors.
# HTTP clients normalize the values; indexing and search validate the returned batches.
