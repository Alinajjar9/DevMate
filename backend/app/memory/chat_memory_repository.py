# Persist raw chat turns and a separate summary per session.
# Compaction changes the summary, not the recoverable raw transcript.
...
class ChatMemoryRepository:
    ...
    # Fill the pending assistant reply once; do not replace an already completed historical turn.
    def complete_turn(
        self,
        session_id: str,
        ordinal: int,
    ...
    # Store the summary separately from chat_turns, preserving the recoverable raw transcript.
    def save_summary(
        self,
        session_id: str,
        content: ChatSummaryContent,
