# Define the validated HTTP data shapes and shared protocol limits.
# Routes accept these models so malformed input is rejected at the API boundary.
...
from ..memory.chat_memory_contracts import (
...
from ..indexing.knowledge_contracts import (
    MAX_CHUNKS_PER_FILE,
...
def _utf16_character_count(value: str) -> int:
    # JavaScript counts UTF-16 code units; match that count for characters such as emoji too.
