// Collect the selected scope and exact workspace content for a request.
// Project search supplies candidates; attachments and explicit selections stay separate.

import * as path from 'path';
import * as vscode from 'vscode';
import type { AskContextItem, AskScope } from '../api/types';
import { knowledgeIndexWorkspaceKey } from '../projectSearch/indexSynchronization';
import {
  containsBinaryData,
...
import type { ConversationWorkspace } from '../sessions/sessions';
...
export class WorkspaceContext {
  ...
  private projectIndexStorageUri(): vscode.Uri | undefined {
    return this.storageDirectory
      ? vscode.Uri.joinPath(this.storageDirectory, PROJECT_INDEX_FILE_NAME)
      : undefined;
  }
