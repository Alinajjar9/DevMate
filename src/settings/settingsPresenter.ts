// Publish settings form state and report save results to the chat view.
// Validation and persistence are delegated to the settings controller.
...
import type { RememberedCommand } from '../workspace/permissions';
