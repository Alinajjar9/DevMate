// Read, validate, and save general settings and tool limits.
// Keep configuration rules independent of how the settings form is displayed.
...
import type { AgentToolSettings } from '../agent/agentTools';
import {
...
import type { FilePermissionPolicy } from '../workspace/permissions';
