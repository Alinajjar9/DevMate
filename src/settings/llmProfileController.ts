// Manage chat-model profiles and their separate SecretStorage entries.
// The built-in profile is combined with saved custom profiles when reading state.

import { randomUUID } from 'crypto';
import { isValidModelContextWindowTokens } from '../context/contextPlanner';
import {
