/** VS Code entry point: creates the chat view and backend manager, then registers their lifetimes. */

import * as fs from 'fs';
import * as vscode from 'vscode';
import { health } from './api/client';
import { LocalBackendManager } from './backendManager';
import { DevMateChatViewProvider } from './chatViewProvider';

/** Wire up commands, status updates and diff previews. VS Code disposes these registrations on shutdown. */
