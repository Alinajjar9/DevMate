// Handle session dialogs and turn session state into chat-view messages.
// The session controller owns persistence and transcript changes.
...
import type { WorkspaceContext } from '../context/workspaceContext';
