// Define chat/session data and pure state transformations.
// Saved transcripts and the bounded history sent to the model have different limits.

import type { ConversationTurn, AgentToolStep, AssistantMode } from '../api/types';
import { parseFileChangeSummary } from '../workspace/fileTools';
import type { FileChangeSummaryItem } from '../workspace/fileTools';
import { AGENT_TOOL_NAMES } from '../agent/agentToolProtocol';
import type { AgentToolName } from '../agent/agentToolProtocol';
