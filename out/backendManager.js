...
exports.createBackendRequestToken = createBackendRequestToken;
exports.backendLaunchEnvironment = backendLaunchEnvironment;
...
class LocalBackendManager {
    ...
    checkHealth(backendUrl, backendToken = this.backendToken) {
        return backendToken
